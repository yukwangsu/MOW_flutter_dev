...
class LikeCuration extends StatefulWidget {
  const LikeCuration({
    super.key,
  });

  @override
  State<LikeCuration> createState() => _LikeCurationState();
}

class _LikeCurationState extends State<LikeCuration> {
  late Future<MyCurationListModel> myCurationList;

  @override
  void initState() {
    super.initState();
    myCurationList = CurationService.getLikeCuration();
  }
